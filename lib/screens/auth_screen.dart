  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXIST')) {
        ...
        errorMessage =
            'We have blocked all requests from this device due to unususal activity. Try again later.';
      } else if (error.toString().contains('INVALID_EMAIL')) {
        errorMessage = 'Invalid email address';
      } else if (error.toString().contains('WEAK_PASSWORD')) {
        errorMessage = 'This password is too weak';
      } else if (error.toString().contains('EMAIL_NOT_FOUND')) {
        errorMessage = 'Could not find a user with given email id';
            ...
            child: Column(
              children: <Widget>[
                TextFormField(
                  ...
                  onSaved: (value) {
                    _authData['email'] = value!.isEmpty ? '' : value;
                  },
                ),
                TextFormField(
                  ...
                  onSaved: (value) {
                    _authData['password'] = value!.isEmpty ? '' : value;
                  },
                ),
                AnimatedContainer(
                  constraints: BoxConstraints(
